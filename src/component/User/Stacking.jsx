...
const Stack = () => {
  const [stackActiveButton, setStackActiveButton] = useState("off"); // State to track the active button
  const [stack3activeButton, setStack3ActiveButton] = useState("off"); // Default active state
  return (
    <>
      {/* Staking Input */}
      <div>
          ...
          <div className="flex items-center">
            <div class="hs-dropdown relative inline-flex">
              <button
                ...
                type="button"
                class="hs-dropdown-toggle p-2.5 px-4 flex items-center gap-x-2  text-sm font-medium rounded-lg border border-gray-200  text-gray-50 shadow-sm "
                aria-haspopup="menu"
                aria-expanded="false"
                aria-label="Dropdown"
              >
      ...
      <div className="mt-4 text-sm">
        ...
        <div className="flex items-center justify-between mt-3">
          ...
          <div className="flex border border-gray-600 rounded-full overflow-hidden divide-x-2 divide-slate-400/25">
            {/* Off Button */}
            <button
              onClick={() => setStackActiveButton("off")}
            ...
            {/* On Button */}
            <button
              onClick={() => setStackActiveButton("on")}
        ...
        <div className="flex items-center justify-between mt-3">
          ...
          <div className="flex border border-gray-600 rounded-full overflow-hidden divide-x-2 divide-slate-400/25">
            {/* Off Button */}
            <button
              onClick={() => setStack3ActiveButton("off")}
              className={`py-1 px-2.5 text-sm text-white transition-all shadow-sm hover:shadow focus:bg-slate-700 hover:bg-slate-700 active:shadow-none ${
                stack3activeButton === "off" ? "bg-slate-700 shadow-none" : ""
              }`}
              type="button"
            >
              Off
            ...
            {/* High Button */}
            <button
              onClick={() => setStack3ActiveButton("high")}
              className={`py-1 px-2.5 text-sm text-white transition-all shadow-sm hover:shadow focus:bg-slate-700 hover:bg-slate-700 active:shadow-none ${
                stack3activeButton === "high" ? "bg-slate-700 shadow-none" : ""
              }`}
              type="button"
            >
              High
            ...
            {/* Low Button */}
            <button
              onClick={() => setStack3ActiveButton("low")}
              className={`py-1 px-2.5 text-sm text-white transition-all shadow-sm hover:shadow focus:bg-slate-700 hover:bg-slate-700 active:shadow-none ${
                stack3activeButton === "low" ? "bg-slate-700 shadow-none" : ""
              }`}
              type="button"
            >
              Low
...
const Stackbtn = () => {
  return (
    <>
      <div className="">
        <button
          class="flex-1 text-xs font-medium py-1.5 px-2 rounded-2xl whitespace-nowrap transition-colors duration-150 ease-in-out    bg-[#6fb153] text-slate-900"
          tabindex="0"
        >
          <span class="text-white">≈ 1.162 SOL</span>
        </button>
      </div>
    </>
  );
...
const Stacking = () => {
  ...
  const tabs = [
    { id: 1, label: "Stake", content: <Stack />, button: <Stackbtn /> },
    { id: 2, label: "Unstake", content: <Unstack />, button: " " },
  ];
  ...
  return (
    ...
    <div className=" text-white">
      <div className="w-full flex items-center justify-between bg-[#0000000d] bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-20 ">
        ...
        <div className="flex items-center gap-2">
          <div className="flex gap-2 p-3 px-4 items-center rounded-full bg-purple">
          ...
          <div className="w-fit h-fit mr-4 border p-2 border-[#B96BFC] rounded-full  flex justify-center items-center ">
      ...
      <div className="w-[90%] bg-[#18181B]  max-w-md p-6 px-4  rounded-3xl shadow-lg mx-auto my-3 border border-gray-600">
        {/* Heading */}
