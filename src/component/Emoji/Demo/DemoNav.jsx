...
function DemoNav() {
  ...
  return (
    <div className="mb-2">
      ...
      />
      <div className="peer rounded-full duration-300 w-24 h-5 bg-white peer-focus:ring-2 peer-focus:ring-blue-500 after:content-['Live'] after:absolute after:rounded-full after:h-4 after:w-12 after:bg-[#21C004] after:top-0.5 after:left-1 after:flex after:justify-center after:items-center after:text-white after:font-medium text-[11px] peer-checked:after:translate-x-12 peer-checked:after:content-['Demo'] peer-checked:after:bg-[#000]">
      </div>
    </label>
          <div className="flex ">
