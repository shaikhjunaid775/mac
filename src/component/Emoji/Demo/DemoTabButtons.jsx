          ...
          <div className="px-3 flex justify-between gap-7">
            <div className="flex flex-col w-2/4">
              <div className="flex gap-5 mb-1 items-center">
                <span className="inline-flex items-center gap-x-1.5 py-0.5 px-2 rounded-full text-xs font-medium bg-gradient-to-b from-[#1a1a1a] to-[#585858] text-white  ">
