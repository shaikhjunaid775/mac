      ...
      <nav className="bg-white text-black ">
        <div className=" grid grid-cols-3 items-center justify-between mx-auto p-2">
          ...
          <div className="flex justify-center items-center ">
            <h5
              className="block text-lg whitespace-nowrap  md:p-0 text-dark font-normal"
            >
              Safe
            </h5>
          </div>
      ...
      <div className="px-1.5">
        <div className="my-3">
          <div className="flex justify-center">
            <span class="bg-white text-red-500 text-xs font-normal  px-7 py-0.5 rounded-full ">
              Interest rate 0.10%
            </span>
          </div>
        </div>
          ...
          <div className="p-3">
            <div className="flex justify-between flex-col h-20">
              <div className="flex justify-between items-center ">
                ...
                <span class="border border-white stroke-transparent text-white text-xs font-normal inline-flex gap-1 items-center px-4 py-0.5 rounded-lg ">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    fill="currentColor"
        ...
        <div className="w-full p-1 mt-6 ">
          <div>
            <div className="p-3 pb-0 bg-white rounded-lg mb-4">
              <div class="grid grid-cols-2 divide-x text-center">
                <div className="">
                  ...
                  <div>
                    <h5 className="text-gray-500 text-sm">Generated revenue</h5>
                  </div>
                  <div>
                    <span class="border border-gray-400 bg-white text-gray-400 text-xs font-normal py-[1px] px-5 rounded-full ">
                ...
                <div className="">
                  <div>
                    <h5 className="text-black text-md">₹0.00</h5>
                  </div>
                  <div>
              ...
              <div className="flex my-2">
                <button
                  type="button"
                  class="text-[#ED8A1F]  border border-[#ED8A1F] font-medium rounded-md text-sm w-full text-center me-2 mb-2 "
                >
                  Transfer Out
                </button>
                <button
                  type="button"
                  class="text-white bg-[#ED8A1F]  font-medium rounded-md text-sm  py-1.5 me-2 mb-2  w-full"
                >
                  Transfer In
                </button>
              </div>
              ...
              <div className="flex mt-3 justify-center items-center gap-1">
                <span className="text-sm text-gray-500">Learn about safes</span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
            ...
            <div className="my-6">
              <button
                type="button"
                className="text-[#ED8A1F] border border-[#ED8A1F] font-medium rounded-full w-full text-sm px-5 py-2.5 text-center me-2 mb-2 "
              >
                All history
              </button>
            </div>
